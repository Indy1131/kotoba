      ...
      <div className="bg-gradient-to-t from-midlight to-highlight backdrop-blur-sm rounded-lg p-6 border w-full border-primary mb-4">
        <div className="text-primary text-lg px-2 py-2">
          <motion.div
            ...
            className="absolute"
          >
            Ch<span className="text-red-500 animate-pulse">oo /ʊ/ </span>se your
            pr<span className="text-red-500 animate-pulse">e /i/ </span>
            configured style.
          </motion.div>

          <motion.div
            animate={
              greenParts[0] && greenParts[1] ? { opacity: 1 } : { opacity: 0 }
            }
            transition={{ duration: 0.3, delay: 0.2 }}
            className="relative"
          >
            Ch<span className="text-green-400">oo</span>se your pr
            <span className="text-green-400">e</span>configured style.
          </motion.div>
        </div>
      </div>
