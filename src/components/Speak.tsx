...
export default function Speak({ startAnimation = false }: SpeakProps) {
  ...
  const fullText =
    "Choose your preconfigured style. Input your text. And say it out loud!";
  ...
  const resetAnimations = () => {
    ...
    setCurrentIndex(0);
    setIsDropdownOpen(false);
    setSelectedAccent("Standard American");
  ...
  return (
    <div className="p-6 h-full flex flex-col flex-1 bg-light rounded-lg p-2 border border-light-outline font-['Helvetica'] relative">
      {/* Replay Button */}
      ...
      {/* <button
        ...
        className="cursor-pointer w-10 h-10 bg-gradient-to-t from-midlight to-highlight border-1 text-primary backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-200 z-10"
      ...
      <div className="bg-gradient-to-t from-midlight to-highlight backdrop-blur-sm rounded-lg p-4 border w-full border-primary mb-4">
        <div className="text-primary font-medium text-lg min-h-[2rem] flex items-center">
      ...
      <div className="relative">
        <div className="w-full backdrop-blur-sm rounded-lg p-3 border border-light-outline font-['Helvetica'] flex items-center justify-between">
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
          className="absolute top-full left-0 right-0 mt-1 backdrop-blur-sm rounded-lg border border-white/20 overflow-hidden"
        >
          <div className="py-1">
            <div
              className={`w-full px-3 py-2 text-left text-black ${
